...
<template>
  <section class="py-32 bg-white dark:bg-primary-950 min-h-screen relative overflow-hidden selection:bg-secondary-600 selection:text-white transition-colors duration-500">
